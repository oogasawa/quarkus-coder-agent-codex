...
/**
 * JBang launcher for quarkus-coder-agent-codex.
...
class coder_agent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Starting quarkus-coder-agent-codex on http://localhost:" + port + "/");
    ...
    private static File locateJar() {
        ...
        candidates.add(Paths.get(System.getProperty("user.home"),
                                 "works", "quarkus-coder-agent-codex", "target",
        ...
        candidates.add(Paths.get(System.getProperty("user.home"),
                                 ...
                                 VERSION, "quarkus-coder-agent-codex-" + VERSION + ".jar"));
        ...
        String message = "quarkus-coder-agent-codex jar not found.\nChecked locations:\n"
            + candidates.stream()
                        .map(Path::toString)
                        .collect(Collectors.joining("\n - ", " - ", ""))
            + "\nRun `cd ~/works/quarkus-coder-agent-codex && mvn install` "
