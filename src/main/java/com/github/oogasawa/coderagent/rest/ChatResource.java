...
import com.github.oogasawa.coderagent.service.CodexModelSet;
...
/**
 * REST + SSE endpoint for chat interaction with Codex CLI.
 */
@Path("/api")
@Blocking
public class ChatResource {
    ...
    @ConfigProperty(name = "coder-agent.title", defaultValue = "quarkus-coder-agent-codex")
    String appTitle;
    ...
    public ChatEvent respond(RespondRequest request) {
        ...
        try {
            ...
            logger.log(Level.WARNING, "Failed to send response to Codex", e);
