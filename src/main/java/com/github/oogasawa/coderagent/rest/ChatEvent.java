 ...
 * <ul>
 *   <li>{@code delta} - Partial text content from Codex</li>
 ...
 *   <li>{@code prompt} - Interactive prompt from Codex (tool permission, yes/no, etc.)</li>
...
public record ChatEvent(
    ...
    /**
     * Creates a prompt event for interactive Codex prompts (tool permission, yes/no, etc.).
     *
