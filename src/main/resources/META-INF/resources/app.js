...
(function () {
    ...
    var savedTitle = localStorage.getItem('coder-agent-codex-custom-title');
    if (savedTitle) {
    ...
    appTitle.addEventListener('blur', function () {
        ...
        if (t && t !== defaultTitle) {
            localStorage.setItem('coder-agent-codex-custom-title', t);
        } else {
            localStorage.removeItem('coder-agent-codex-custom-title');
